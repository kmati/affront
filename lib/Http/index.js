...
export const Http = {
	...
	get(key, url, callback) {
		request('GET', url, null, (err, value) => {
			if (err) {
				callback(err);
				return;
			}
	...
	post(key, url, data, callback) {
		request('POST', url, data, (err, value) => {
			if (err) {
				callback(err);
				return;
			}
	...
	put(key, url, data, callback) {
		request('PUT', url, data, (err, value) => {
			if (err) {
				callback(err);
				return;
			}
	...
	delete(key, url, callback) {
		request('DELETE', url, null, (err, value) => {
			if (err) {
				callback(err);
				return;
			}
	...
	patch(key, url, data, callback) {
		request('PATCH', url, data, (err, value) => {
			if (err) {
				callback(err);
				return;
			}
